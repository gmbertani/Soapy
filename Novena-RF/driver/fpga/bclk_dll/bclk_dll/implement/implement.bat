...
xst -ifn xst.scr
move bclk_dll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\bclk_dll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc bclk_dll_exdes.ucf bclk_dll_exdes

echo 'Running map'
map -timing -pr b bclk_dll_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm bclk_dll_exdes -w routed.ncd routed.vhd
cd ..
