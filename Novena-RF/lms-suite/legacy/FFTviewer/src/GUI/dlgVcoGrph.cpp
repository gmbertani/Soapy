...
//(*IdInit(dlgVcoGrph)
const long dlgVcoGrph::ID_STATICTEXT1 = wxNewId();
...
void dlgVcoGrph::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticText1 = new wxStaticText(Panel1, ID_STATICTEXT1, _("VCO GRAPH HERE"), wxPoint(208,184), wxDefaultSize, 0, _T("ID_STATICTEXT1"));
