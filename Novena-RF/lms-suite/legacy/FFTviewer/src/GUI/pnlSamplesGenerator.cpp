...
void pnlSamplesGenerator::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	rgrDataSource = new wxRadioBox(this, ID_RADIOBOX1, _("Data Source:"), wxPoint(8,8), wxDefaultSize, 4, __wxRadioBoxChoices_1, 1, wxRA_SPECIFY_COLS, wxDefaultValidator, _T("ID_RADIOBOX1"));
	rgrDataSource->SetSelection(0);
	...
	btnOpenFile = new wxButton(this, ID_BUTTON3, _("Generate"), wxPoint(8,115), wxSize(112,23), 0, wxDefaultValidator, _T("ID_BUTTON3"));
	Panel1 = new wxPanel(this, ID_PANEL1, wxPoint(8,145), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL1"));
