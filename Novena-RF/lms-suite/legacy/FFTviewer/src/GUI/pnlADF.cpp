...
//(*IdInit(pnlADF)
const long pnlADF::ID_STATICTEXT1 = wxNewId();
const long pnlADF::ID_STATICTEXT2 = wxNewId();
const long pnlADF::ID_STATICTEXT3 = wxNewId();
const long pnlADF::ID_COMBOBOX1 = wxNewId();
const long pnlADF::ID_COMBOBOX2 = wxNewId();
const long pnlADF::ID_SPINCTRL1 = wxNewId();
const long pnlADF::ID_STATICTEXT4 = wxNewId();
const long pnlADF::ID_STATICTEXT5 = wxNewId();
const long pnlADF::ID_COMBOBOX3 = wxNewId();
const long pnlADF::ID_SPINCTRL2 = wxNewId();
const long pnlADF::ID_STATICTEXT6 = wxNewId();
const long pnlADF::ID_STATICTEXT7 = wxNewId();
const long pnlADF::ID_COMBOBOX4 = wxNewId();
const long pnlADF::ID_COMBOBOX5 = wxNewId();
const long pnlADF::ID_STATICTEXT8 = wxNewId();
const long pnlADF::ID_STATICTEXT9 = wxNewId();
const long pnlADF::ID_COMBOBOX6 = wxNewId();
const long pnlADF::ID_COMBOBOX7 = wxNewId();
const long pnlADF::ID_STATICTEXT10 = wxNewId();
const long pnlADF::ID_COMBOBOX8 = wxNewId();
const long pnlADF::ID_RADIOBOX1 = wxNewId();
const long pnlADF::ID_RADIOBOX2 = wxNewId();
const long pnlADF::ID_RADIOBOX3 = wxNewId();
const long pnlADF::ID_RADIOBOX4 = wxNewId();
const long pnlADF::ID_RADIOBOX5 = wxNewId();
const long pnlADF::ID_STATICTEXT17 = wxNewId();
const long pnlADF::ID_STATICTEXT18 = wxNewId();
const long pnlADF::ID_COMBOBOX9 = wxNewId();
const long pnlADF::ID_COMBOBOX10 = wxNewId();
const long pnlADF::ID_STATICTEXT19 = wxNewId();
const long pnlADF::ID_STATICTEXT20 = wxNewId();
const long pnlADF::ID_COMBOBOX11 = wxNewId();
const long pnlADF::ID_COMBOBOX12 = wxNewId();
const long pnlADF::ID_STATICTEXT21 = wxNewId();
const long pnlADF::ID_COMBOBOX13 = wxNewId();
const long pnlADF::ID_RADIOBOX6 = wxNewId();
const long pnlADF::ID_RADIOBOX7 = wxNewId();
const long pnlADF::ID_RADIOBOX8 = wxNewId();
const long pnlADF::ID_RADIOBOX9 = wxNewId();
const long pnlADF::ID_RADIOBOX10 = wxNewId();
const long pnlADF::ID_STATICTEXT11 = wxNewId();
const long pnlADF::ID_STATICTEXT12 = wxNewId();
const long pnlADF::ID_TEXTCTRL1 = wxNewId();
const long pnlADF::ID_TEXTCTRL2 = wxNewId();
const long pnlADF::ID_STATICTEXT13 = wxNewId();
const long pnlADF::ID_STATICTEXT14 = wxNewId();
const long pnlADF::ID_STATICTEXT15 = wxNewId();
const long pnlADF::ID_STATICTEXT16 = wxNewId();
const long pnlADF::ID_BUTTON1 = wxNewId();
//*)

BEGIN_EVENT_TABLE(pnlADF,wxPanel)
	//(*EventTable(pnlADF)
	//*)
END_EVENT_TABLE()

pnlADF::pnlADF(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size, int styles, wxString idname)
{
	BuildContent(parent,id,pos,size);
}

void pnlADF::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	//(*Initialize(pnlADF)
	...
	cmbCPG = new wxComboBox(this, ID_COMBOBOX3, wxEmptyString, wxDefaultPosition, wxSize(65,21), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX3"));
	...
	spinNCnt = new wxSpinCtrl(this, ID_SPINCTRL2, _T("384"), wxDefaultPosition, wxSize(70,21), 0, 0, 1000000000, 384, _T("ID_SPINCTRL2"));
	...
	btnCalcSend = new wxButton(this, ID_BUTTON1, _("Calculate R, N & Download"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
	...
	Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&pnlADF::OnbtnCalcSendClick);
	//*)
}
...
void pnlADF::OnbtnCalcSendClick(wxCommandEvent& event)
{
    //reference counter latch
