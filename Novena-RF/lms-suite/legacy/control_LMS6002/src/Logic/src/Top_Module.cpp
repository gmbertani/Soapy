...
void Top_Module::Initialize(Main_Module *pMain, char MAddr)
{
	...
	m_psD.iLen = TopLen;
	m_psD.cCmdW = new unsigned char[m_psD.iLen];
	m_psD.cDataW = new unsigned char[m_psD.iLen];
	m_psD.cCmdR = new unsigned char[m_psD.iLen];
	m_psD.cDataR = new unsigned char[m_psD.iLen];
