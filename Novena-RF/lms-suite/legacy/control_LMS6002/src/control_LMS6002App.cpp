...
IMPLEMENT_APP(control_LMS6002App);
...
bool control_LMS6002App::OnInit()
{
    #ifdef WIN32
    ...
    if ( wxsOK )
    {
    	frControlPanel* Frame = new frControlPanel(0);
    	Frame->Show();
    	SetTopWindow(Frame);
    }
    //*)
