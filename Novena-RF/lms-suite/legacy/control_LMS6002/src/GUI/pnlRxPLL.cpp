...
void pnlRxPLL::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	btnChoose = new wxButton(Panel2, ID_BUTTON1, _("Select"), wxPoint(216,32), wxSize(75,-1), 0, wxDefaultValidator, _T("ID_BUTTON1"));
	btnClbr = new wxButton(Panel2, ID_BUTTON2, _("Calibration"), wxPoint(216,0), wxSize(75,-1), 0, wxDefaultValidator, _T("ID_BUTTON2"));
	...
	btnTune = new wxButton(Panel2, ID_BUTTON3, _("Tune"), wxPoint(0,32), wxSize(75,-1), 0, wxDefaultValidator, _T("ID_BUTTON3"));
	...
	cmbVCOCAP = new wxComboBox(Panel2, ID_COMBOBOX1, wxEmptyString, wxPoint(152,32), wxSize(64,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX1"));
	...
	FlexGridSizer12->Add(StaticText3, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbVOVCOREG = new wxComboBox(this, ID_COMBOBOX2, wxEmptyString, wxDefaultPosition, wxSize(72,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX2"));
	FlexGridSizer12->Add(cmbVOVCOREG, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	btnReadVtune = new wxButton(Panel3, ID_BUTTON4, _("Read"), wxPoint(8,32), wxSize(75,-1), 0, wxDefaultValidator, _T("ID_BUTTON4"));
	...
	Panel6 = new wxPanel(this, ID_PANEL6, wxDefaultPosition, wxSize(294,127), wxTAB_TRAVERSAL, _T("ID_PANEL6"));
	...
	cmbICHP = new wxComboBox(this, ID_COMBOBOX5, wxEmptyString, wxDefaultPosition, wxSize(78,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX5"));
	FlexGridSizer4->Add(cmbICHP, 1, wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbOFFUP = new wxComboBox(this, ID_COMBOBOX6, wxEmptyString, wxDefaultPosition, wxSize(83,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX6"));
	FlexGridSizer4->Add(cmbOFFUP, 1, wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbOFFDOWN = new wxComboBox(this, ID_COMBOBOX7, wxEmptyString, wxDefaultPosition, wxSize(75,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX7"));
	...
	cmbSELOUT = new wxComboBox(this, ID_COMBOBOX8, wxEmptyString, wxDefaultPosition, wxSize(81,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX8"));
	...
	cmbDITHN = new wxComboBox(Panel15, ID_COMBOBOX9, wxEmptyString, wxPoint(64,16), wxSize(80,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX9"));
	...
	rgrMODE = new wxRadioBox(Panel4, ID_RADIOBOX2, _("PLL Mode"), wxPoint(8,8), wxDefaultSize, 2, __wxRadioBoxChoices_2, 2, wxRA_SPECIFY_COLS, wxDefaultValidator, _T("ID_RADIOBOX2"));
	...
	rgrSELVCO = new wxRadioBox(Panel4, ID_RADIOBOX3, _("Current VCO"), wxPoint(368,8), wxDefaultSize, 5, __wxRadioBoxChoices_3, 1, wxRA_SPECIFY_COLS, wxDefaultValidator, _T("ID_RADIOBOX3"));
	...
	FlexGridSizer13->Add(StaticText6, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer13->Add(cmbACODE, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer13->Add(StaticText7, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer13->Add(cmbBCODE, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer8->Add(FlexGridSizer13, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	rgrFRANGE = new wxRadioBox(Panel4, ID_RADIOBOX4, _("MUX/DIV Selection"), wxPoint(368,128), wxDefaultSize, 5, __wxRadioBoxChoices_4, 1, wxRA_SPECIFY_COLS, wxDefaultValidator, _T("ID_RADIOBOX4"));
	...
	FlexGridSizer11->Add(rgrBINSEL, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	Connect(ID_COMBOBOX1,wxEVT_COMMAND_COMBOBOX_SELECTED,(wxObjectEventFunction)&pnlRxPLL::cmbVCOCAPChange);
