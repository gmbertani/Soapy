...
const long pnlTxLPF::ID_COMBOBOX1 = wxNewId();
const long pnlTxLPF::ID_COMBOBOX2 = wxNewId();
const long pnlTxLPF::ID_BUTTON5 = wxNewId();
const long pnlTxLPF::ID_STATICTEXT3 = wxNewId();
const long pnlTxLPF::ID_STATICTEXT7 = wxNewId();
const long pnlTxLPF::ID_STATICTEXT4 = wxNewId();
const long pnlTxLPF::ID_STATICTEXT8 = wxNewId();
const long pnlTxLPF::ID_STATICTEXT5 = wxNewId();
const long pnlTxLPF::ID_STATICTEXT9 = wxNewId();
const long pnlTxLPF::ID_STATICTEXT6 = wxNewId();
const long pnlTxLPF::ID_STATICTEXT10 = wxNewId();
const long pnlTxLPF::ID_CHECKBOX2 = wxNewId();
const long pnlTxLPF::ID_CHECKBOX1 = wxNewId();
const long pnlTxLPF::ID_CHECKBOX3 = wxNewId();
const long pnlTxLPF::ID_CHECKBOX4 = wxNewId();
const long pnlTxLPF::ID_CHECKBOX5 = wxNewId();
const long pnlTxLPF::ID_CHECKBOX6 = wxNewId();
const long pnlTxLPF::ID_COMBOBOX3 = wxNewId();
const long pnlTxLPF::ID_RADIOBOX1 = wxNewId();
const long pnlTxLPF::ID_STATICTEXT11 = wxNewId();
const long pnlTxLPF::ID_STATICTEXT12 = wxNewId();
const long pnlTxLPF::ID_COMBOBOX4 = wxNewId();
const long pnlTxLPF::ID_COMBOBOX5 = wxNewId();
const long pnlTxLPF::ID_RADIOBOX2 = wxNewId();
//*)
...
pnlTxLPF::pnlTxLPF(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size, int styles, wxString idname)
{
    m_frmADDC = NULL;
	m_cVer = 2;
	m_cRev = 2;
...
void pnlTxLPF::Initialize(pnlADDC *ADDC)
{
	sendChanges = false;
	m_cMAddr = LMLL_TxLPFGetAddr();
	m_frmADDC = ADDC;
    FillComboBoxes();
	SetGuiDefaults();
	sendChanges = true;
...
void pnlTxLPF::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	cmbDCCalAddr = new wxComboBox(this, ID_COMBOBOX1, wxEmptyString, wxPoint(8,56), wxSize(120,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX1"));
	FlexGridSizer5->Add(cmbDCCalAddr, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbCalVal = new wxComboBox(this, ID_COMBOBOX2, wxEmptyString, wxPoint(136,56), wxSize(104,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX2"));
	...
	cmbLpfBw = new wxComboBox(this, ID_COMBOBOX3, wxEmptyString, wxDefaultPosition, wxSize(75,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX3"));
	...
	rgrLpfByp = new wxRadioBox(this, ID_RADIOBOX1, _("Test"), wxPoint(344,120), wxDefaultSize, 2, __wxRadioBoxChoices_1, 1, wxRA_SPECIFY_COLS, wxDefaultValidator, _T("ID_RADIOBOX1"));
	...
	FlexGridSizer1->Add(StaticText8, 1, wxLEFT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 10);
	...
	FlexGridSizer1->Add(cmbDCOffset, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer1->Add(cmbRcCal, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	rgrDecode = new wxRadioBox(this, ID_RADIOBOX2, _("Decoding"), wxPoint(720,8), wxDefaultSize, 2, __wxRadioBoxChoices_2, 1, wxRA_SPECIFY_COLS, wxDefaultValidator, _T("ID_RADIOBOX2"));
	...
	Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&pnlTxLPF::btnDCRstClbrClick);
	Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&pnlTxLPF::btnDCLoadValClick);
	Connect(ID_BUTTON4,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&pnlTxLPF::btnDCStartClbrClick);
	Connect(ID_COMBOBOX1,wxEVT_COMMAND_COMBOBOX_SELECTED,(wxObjectEventFunction)&pnlTxLPF::cmbDCCalAddrChange);
	Connect(ID_COMBOBOX2,wxEVT_COMMAND_COMBOBOX_SELECTED,(wxObjectEventFunction)&pnlTxLPF::cmbCalValChange);
	Connect(ID_BUTTON5,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&pnlTxLPF::btnDCReadValClick);
	Connect(ID_CHECKBOX2,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlTxLPF::chbPwrLpfModsClick);
	Connect(ID_CHECKBOX1,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlTxLPF::chbPwrLpfClick);
	Connect(ID_CHECKBOX3,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlTxLPF::chbPwrDCDacClick);
	Connect(ID_CHECKBOX4,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlTxLPF::chbPwrDCRefClick);
	Connect(ID_CHECKBOX5,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlTxLPF::chbPwrDCCmprClick);
	Connect(ID_CHECKBOX6,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlTxLPF::chbTX_DACBUF_ENClick);
	Connect(ID_COMBOBOX3,wxEVT_COMMAND_COMBOBOX_SELECTED,(wxObjectEventFunction)&pnlTxLPF::cmbLpfBwChange);
	Connect(ID_RADIOBOX1,wxEVT_COMMAND_RADIOBOX_SELECTED,(wxObjectEventFunction)&pnlTxLPF::rgrLpfBypClick);
	Connect(ID_COMBOBOX4,wxEVT_COMMAND_COMBOBOX_SELECTED,(wxObjectEventFunction)&pnlTxLPF::cmbDCOffsetChange);
	Connect(ID_COMBOBOX5,wxEVT_COMMAND_COMBOBOX_SELECTED,(wxObjectEventFunction)&pnlTxLPF::cmbRcCalChange);
	Connect(ID_RADIOBOX2,wxEVT_COMMAND_RADIOBOX_SELECTED,(wxObjectEventFunction)&pnlTxLPF::rgrDecodeClick);
	//*)
}
...
bool pnlTxLPF::UpdateGUI()
{
	...
	LMLL_TxLPFGetDCCalibrationData(iDC_REGVAL, iDC_LOCK, iDC_CLBR_DONE, iDC_UD);
	// DC_REGVAL[5:0]
	...
	// DC_CNTVAL[5:0]
	//cmbCalVal->SetSelection( LMLL_TxLPFGetCalVal();
	...
	cmbDCCalAddr->SetSelection( LMLL_TxLPFGetDCCalAddr());

	// BWC_LPF[3:0]
	cmbLpfBw->SetSelection( LMLL_TxLPFGetLpfBw());

	// EN
	chbPwrLpfMods->SetValue(LMLL_TxLPFGetPwrLpfMods());

	// DECODE
	rgrDecode->SetSelection( LMLL_TxLPFGetDecode());

	// BYP_EN_LPF
	rgrLpfByp->SetSelection( LMLL_TxLPFGetLpfByp());

	// DCO_DACCAL_LPF[5:0]
	cmbDCOffset->SetSelection( LMLL_TxLPFGetDCOffset());

	// TX_DACBUF_EN
	if (m_cMAddr == TxLpfAddr)
	{
		chbTX_DACBUF_EN->SetValue(LMLL_TxLPFGetTX_DACBUF_EN());
		// chbTX_DACBUF_EN->SetValue(!chbTX_DACBUF_EN->Checked);
	};

	// RCCAL_LPF[2:0]
	cmbRcCal->SetSelection( LMLL_TxLPFGetRcCal());

	// PD_DCOCMP_LPF
	chbPwrDCCmpr->SetValue(LMLL_TxLPFGetPwrDCCmpr());
	// chbPwrDCCmpr->SetValue(!chbPwrDCCmpr->Checked);

	// PD_DCODAC_LPF
	chbPwrDCDac->SetValue(LMLL_TxLPFGetPwrDCDac());
	// chbPwrDCDac->SetValue(!chbPwrDCDac->Checked);

	// PD_DCOREF_LPF
	chbPwrDCRef->SetValue(LMLL_TxLPFGetPwrDCRef());
	// chbPwrDCRef->SetValue(!chbPwrDCRef->Checked);

	// PD_FIL_LPF
	chbPwrLpf->SetValue(LMLL_TxLPFGetPwrLpf());
...
// ---------------------------------------------------------------------------
void pnlTxLPF::cmbLpfBwChange(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetLpfBw(cmbLpfBw->GetSelection());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::chbPwrLpfModsClick(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetPwrLpfMods(chbPwrLpfMods->GetValue());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::rgrDecodeClick(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetDecode(rgrDecode->GetSelection());
	SetGuiDecode();
}

// ---------------------------------------------------------------------------
void pnlTxLPF::rgrLpfBypClick(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetLpfByp(rgrLpfByp->GetSelection());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::cmbDCOffsetChange(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetDCOffset(cmbDCOffset->GetSelection());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::cmbRcCalChange(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetRcCal(cmbRcCal->GetSelection());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::chbPwrLpfClick(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetPwrLpf(chbPwrLpf->GetValue());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::chbPwrDCDacClick(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetPwrDCDac(chbPwrDCDac->GetValue());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::chbPwrDCRefClick(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetPwrDCRef(chbPwrDCRef->GetValue());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::chbPwrDCCmprClick(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetPwrDCCmpr(chbPwrDCCmpr->GetValue());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::chbTX_DACBUF_ENClick(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetTX_DACBUF_EN(chbTX_DACBUF_EN->GetValue());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::cmbDCCalAddrChange(wxCommandEvent& event)
{
	if(sendChanges) LMLL_TxLPFSetDCCalAddr(cmbDCCalAddr->GetSelection());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::cmbCalValChange(wxCommandEvent& event)
{
	//if(sendChanges) LMLL_TxLPFSetCalVal(cmbCalVal->GetSelection());
}

// ---------------------------------------------------------------------------
void pnlTxLPF::btnDCRstClbrClick(wxCommandEvent& event)
{
	LMLL_TxLPFDCResetCalibration();
}

// ---------------------------------------------------------------------------
void pnlTxLPF::btnDCLoadValClick(wxCommandEvent& event)
{
	LMLL_TxLPFDCLoadValues(cmbCalVal->GetSelection());
}

void pnlTxLPF::btnDCReadValClick(wxCommandEvent& event)
{
	int DC_regVal;
	int DC_lock;
	int DC_clbr;
	int DC_ud;
	LMLL_TxLPFGetDCCalibrationData(DC_regVal, DC_lock, DC_clbr, DC_ud);
	// DC_REGVAL[5:0]
...
// ---------------------------------------------------------------------------
void pnlTxLPF::btnDCStartClbrClick(wxCommandEvent& event)
{
	LMLL_TxLPFDCStartCalibration();
}

void pnlTxLPF::OnEraseBackground(wxEraseEvent& event)
{
}

void pnlTxLPF::FillComboBoxes()
{
    Freeze();
