...
void pnlTxRF::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	chbFST_PKDET = new wxCheckBox(this, ID_CHECKBOX10, _("Short the Resistors in PDED"), wxDefaultPosition, wxSize(-1,13), 0, wxDefaultValidator, _T("ID_CHECKBOX10"));
	chbFST_PKDET->SetValue(false);
	...
	rgrLOOPBBEN = new wxRadioBox(this, ID_RADIOBOX3, _("BB Loop Back Control"), wxPoint(192,224), wxDefaultSize, 4, __wxRadioBoxChoices_1, 1, wxRA_SPECIFY_COLS, wxDefaultValidator, _T("ID_RADIOBOX3"));
	FlexGridSizer5->Add(rgrLOOPBBEN, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	rgrPA = new wxRadioBox(this, ID_RADIOBOX1, _("PA Selection"), wxPoint(368,8), wxDefaultSize, 3, __wxRadioBoxChoices_2, 1, wxRA_SPECIFY_COLS, wxDefaultValidator, _T("ID_RADIOBOX1"));
	...
	rgrDecode = new wxRadioBox(this, ID_RADIOBOX2, _("Decoding"), wxPoint(520,8), wxDefaultSize, 2, __wxRadioBoxChoices_3, 1, wxRA_SPECIFY_COLS, wxDefaultValidator, _T("ID_RADIOBOX2"));
	rgrDecode->SetSelection(0);
	FlexGridSizer7->Add(rgrDecode, 1, wxALL|wxALIGN_LEFT|wxALIGN_TOP, 5);
	...
	FlexGridSizer1->Add(cmbVga1G_u, 1, wxRIGHT|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer1->Add(cmbVga1G_t, 1, wxRIGHT|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer2->Add(cmbVga2G_u, 1, wxRIGHT|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer2->Add(cmbVga2G_t, 1, wxLEFT|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
